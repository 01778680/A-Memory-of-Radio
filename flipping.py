...
with open('Channels.txt', 'r') as file:
    ...
    channels = [float(value.strip()) for value in channels if value.strip() != '']
...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq = freq = random.uniform(88e6, 108e6)
        ...
        self.timer.timeout.connect(self.update_freq)
        self.timer.start(1000)

    def update_freq(self):
        random_index = randrange(len(channels))
        self.freq = channels[random_index]
